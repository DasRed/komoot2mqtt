 ...
 * @property {boolean} intervalDisabled
 * @property {boolean} publishDisabled
...
export const options = [
    ...
    {name: 'intervalDisabled', type: Boolean, description: 'Disable the interval functionality and stop the app. Env variable is K2M_INTERVAL_DISABLED.', defaultValue: process.env.K2M_INTERVAL_DISABLED ?? false},
    {name: 'publishDisabled', type: Boolean, description: 'Disable publishing to mqtt. Env variable is K2M_PUBLISH_DISABLED.', defaultValue: process.env.K2M_PUBLISH_DISABLED ?? false},
    ...
    {name: 'homeAssistantDatabaseImportHistoricalData', type: Boolean, description: 'If you want to import historical data into your homeassistant, enable this option. I suggest, that the intervalDisabled and publishDisabled is enabled too. Only mysql/mariadb is supported. Env variable is K2M_HOMEASSISTANT_DATABASE_IMPORT_HISTORICAL_DATA.', defaultValue: process.env.K2M_HOMEASSISTANT_DATABASE_IMPORT_HISTORICAL_DATA ?? false},
...
config.intervalDisabled                          = bool(config.intervalDisabled);
config.publishDisabled                           = bool(config.publishDisabled);
